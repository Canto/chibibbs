...
<form class="form-horizontal" method="post" onsubmit="return checkForm()" action="member.php?cAct=memberJoinOk">
	<script type="text/javascript">
		...
		function checkID(){
				$.ajax({
					url: './member/member.id.check.php',
					type: 'POST',
	...
	<table id="board-create" class="table table-bordered">
		...
		<tr>
			...
			<td class="span9 td-right">
				<input id="user_id" name="user_id" class="input-xlarge" type="text" onblur="checkID()" placeholder="멤버 ID" required><p id="chk_id" class="help-inline"></p>
