...
if(!empty($skin->op->notice_font_color)) echo ".user_notice_background_color {color:".$skin->op->notice_font_color." !important;}\n";
if(!empty($skin->op->table_border_color)) echo ".user_table_border_color {border-color:".$skin->op->table_border_color." !important;}\n";
if(!empty($skin->op->table_border_color)) echo ".user_table_border_color {-webkit-box-shadow:inset 0px 0px 0px 0px rgba(0, 0, 0, 0) !important;-moz-box-shadow:inset 0px 0px 0px 0px rgba(0, 0, 0, 0) !important;box-shadow:inset 0px 0px 0px 0px rgba(0, 0, 0, 0) !important;}\n";
...
if(!empty($skin->op->pic_border_hover)) echo ".user_pic_border_hover:hover {border-color:".$skin->op->pic_border_hover." !important;}\n";
